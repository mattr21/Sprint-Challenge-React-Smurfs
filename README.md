...
- [ ] Explain the differences between `client-side routing` and `server-side routing`.
  ...
  Client-side routing recieves the full data at once that then handles changes within the client. Server-side routing only gives what you need as you call it which requires a page reload to get more.
